...
byte rowPins[ROWS] = {A5, A4, A3, A2};  // Connect to the row pinouts of the keypad: {6, 7, 8 , 9}
byte colPins[COLS] = {11, 12, A0, A1};  // Connect to the column pinouts of the keypad: {2, 3, 4, 5}
